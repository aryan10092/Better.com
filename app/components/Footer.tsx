      ...
      <div className="m-auto px-6 py-6 md:px-10 lg:px-16 xl:px-20 2xl:px-40">
        ...
        <div className="mt-6 flex flex-col gap-y-8 md:flex-row md:gap-16">
          ...
          <div className="flex-shrink flex-grow basis-0">
            <h4 className="font-bold text-gray-900 leading-heading m-0 p-0 tracking-normal w-auto text-base md:text-lg">
              Resources
            </h4>
            <ul className="mt-2 space-y-4 md:mt-6 text-black">
              <li><Link className="hover-gradient-effect block py-1 text-link" href="/how-much-house-can-i-afford">Home affordability calculator</Link></li>
              <li><Link className="hover-gradient-effect block py-1 text-link" href="/b/calculators/mortgage-calculator">Mortgage calculator</Link></li>
              <li><Link className="hover-gradient-effect block py-1 text-link" href="/free-mortgage-calculator">Free mortgage calculator</Link></li>
              <li><Link className="hover-gradient-effect block py-1 text-link" href="/mortgage-calculator-with-taxes">Mortgage calculator with taxes</Link></li>
              <li><Link className="hover-gradient-effect block py-1 text-link" href="/mortgage-calculator-with-pmi">Mortgage calculator with PMI</Link></li>
              <li><Link className="hover-gradient-effect block py-1 text-link" href="/rent-vs-buy-calculator">Rent vs buy calculator</Link></li>
              <li><Link className="hover-gradient-effect block py-1 text-link" href="/heloc-calculator">HELOC payment calculator</Link></li>
              <li><Link className="hover-gradient-effect block py-1 text-link" href="/heloc-vs-cashout-refi-calculator">HELOC vs cash-out refinance calculator</Link></li>
              <li><Link className="hover-gradient-effect block py-1 text-link" href="/content/buying-a-house-online">Buy a home</Link></li>
              <li><Link className="hover-gradient-effect block py-1 text-link" href="/content/buying-and-selling-a-home-at-the-same-time">Sell a home</Link></li>
              <li><Link className="hover-gradient-effect block py-1 text-link" href="/content/home-inspection-checklist">Get home inspection</Link></li>
            </ul>
          </div>
          ...
          <div className="flex-shrink flex-grow basis-0">
            ...
            <ul className="mt-2 space-y-4 md:mt-6 text-black">
              <li><Link className="hover-gradient-effect block py-1 text-link" href="/about-us">About Us</Link></li>
              <li><Link className="hover-gradient-effect block py-1 text-link" href="/about-us/careers">Careers</Link></li>
              <li><Link className="hover-gradient-effect block py-1 text-link" href="/about-us/media">Media</Link></li>
              <li><Link className="hover-gradient-effect block py-1 text-link" href="/b/partnerships">Partner With Us</Link></li>
              <li><Link className="hover-gradient-effect block py-1 text-link" href="/content">Learning center</Link></li>
              <li><Link className="hover-gradient-effect block py-1 text-link" href="/faq">FAQs</Link></li>
              <li><Link href="https://investors.better.com">Investor Relations</Link></li>
            </ul>
          </div>
          ...
          <div className="flex-shrink flex-grow basis-0">
            ...
            <ul className="mt-2 space-y-4 md:mt-6 text-black">
              <li><Link href="mailto:hello@better.com">hello@better.com</Link></li>
              <li><Link href="tel:415-523-8837">415-523-8837</Link></li>
              <li><Link className="hover-gradient-effect block py-1 text-link" href="/faq">FAQ</Link></li>
              <li><Link className="hover-gradient-effect block py-1 text-link" href="/glossary">Glossary</Link></li>
            </ul>

            <h4 className="font-bold text-gray-900 leading-heading m-0 p-0 tracking-normal w-auto text-base md:text-lg mt-6">
              Legal
            </h4>
            <ul className="mt-2 space-y-4 md:mt-6 text-black">
              <li><Link href="http://www.nmlsconsumeraccess.org/EntityDetails.aspx/COMPANY/330511">NMLS Consumer Access</Link></li>
              <li><Link className="hover-gradient-effect block py-1 text-link" href="/about-us/privacy-policy">Privacy Policy</Link></li>
              <li><Link className="hover-gradient-effect block py-1 text-link" href="/about-us/terms-of-use">Terms of Use</Link></li>
              <li><Link className="hover-gradient-effect block py-1 text-link" href="/about-us/licensing-disclosure">Disclosures & Licensing</Link></li>
              <li><Link className="hover-gradient-effect block py-1 text-link" href="/about-us/affiliated-business">Affiliated Business</Link></li>
              <li><Link className="hover-gradient-effect block py-1 text-link" href="/browser-support">Browser Disclaimer</Link></li>
              <li><div id="teconsent"></div></li>
              <li>
                <div className="mt-8 flex gap-4">
                  {/* Equal Housing Lender Logo */}
                  <svg data-qa="ehl-logo" aria-label="Ehl logo" role="img" fill="none" height="40" width="41" xmlns="http://www.w3.org/2000/svg">
        ...
        <div className="mt-12 flex gap-x-4 md:mt-60">
          <div>
            <Link aria-label="Facebook" href="https://www.facebook.com/better/" target="_blank" rel="noopener noreferrer">
              <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="#313131" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="lucide lucide-facebook">
                <path d="M18 2h-3a5 5 0 0 0-5 5v3H7v4h3v8h4v-8h3l1-4h-4V7a1 1 0 0 1 1-1h3z"></path>
              </svg>
            </Link>
          </div>
          <div>
            <Link aria-label="Instagram" href="https://www.instagram.com/betterdotcom/" target="_blank" rel="noopener noreferrer">
              <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="#313131" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="lucide lucide-instagram">
          ...
          <div>
            <Link aria-label="Linkedin" href="https://www.linkedin.com/company/betterdotcom/" target="_blank" rel="noopener noreferrer">
              <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="#313131" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="lucide lucide-linkedin">
        ...
        <div className="mt-12">
          ...
          <p className="font-normal leading-body m-0 p-0 text-left text-gray-900 text-xs mt-4">
            ...
            <Link className="underline" data-qa="nmls-link" href="http://www.nmlsconsumeraccess.org/EntityDetails.aspx/COMPANY/330511">
          ...
          <p className="font-normal leading-body m-0 p-0 text-left text-gray-900 text-xs mt-4">
            <Link className="underline" href="https://www.dos.ny.gov/licensing/docs/FairHousingNotice_new.pdf">
              New York State Housing and Anti-Discrimination Notice
            </Link>
          </p>

          <p className="font-normal leading-body m-0 p-0 text-left text-gray-900 text-xs mt-4">
            <Link className="underline" href="https://media.better.com/pdfs/NYStandardizedOperatingProcedures.pdf">
          ...
          <p className="font-normal leading-body m-0 p-0 text-left text-gray-900 text-xs mt-4">
            ...
            <Link className="underline" href="https://www.har.com/mhf/terms/dispBrokerInfo?sitetype=aws&cid=645736">
              Information About Brokerage Services
            </Link>
            {' | '}
            <Link className="underline" href="https://www.trec.texas.gov/sites/default/files/pdf-forms/CN%201-4-1_1.pdf">
